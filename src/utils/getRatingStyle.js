const getRatingStyle = (score) => {
  if (!score) return 'bg-zinc-800 text-zinc-500 border border-zinc-700/50';
...
export const getRatingFont = (score, groupHover=false) => {
...
export const getRatingBorder = (score) => {
  if (!score) return 'border-zinc-700/50 shadow-none';
...
export const getStatBarStyle = (score) => {
...
export const getRatingHoverBorder = (score) => {
  if (!score) return 'hover:border-zinc-700/70';
