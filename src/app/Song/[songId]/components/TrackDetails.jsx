...
const TrackDetails = ({ songData }) => {
    ...
    // Verificamos si hay productores para reutilizar la lógica
    const hasProducers = songData?.producers && songData.producers.length > 0;
    ...
    return (
        <section className="rounded-[2.5rem] p-8 backdrop-blur-md">
            <div className="flex flex-wrap items-center gap-8">
                ...
                {/* 3. Sección Productores (Solo si existen) */}
                {hasProducers && (
                    <>
                        <div className="h-12 w-[1px] bg-white/10 hidden md:block" />
