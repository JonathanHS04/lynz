...
const songData = {
    ...
    artist: "Omar Courtz",
    artistId: 1,
    features: [{ id: 2, name: "Bad Gyal" }],
    album: "POR SI MAÑANA NO ESTOY",
    albumImage: "https://i1.sndcdn.com/artworks-72d80e69-18fe-4175-b049-3393db902285-0-t500x500.jpg",
    albumId: 1,
    duration: "3:42",
    releaseDate: "2026",
    rating: 9.9,
...
export { userReviews, artistPerformance, songData };