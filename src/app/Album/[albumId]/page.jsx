...
const albumData = {
    ...
    tracks: [
        ...
        { id: 12, title: "WHAT U NEED? (SexPlaylist 2)", duration: "4:26", plays: "12M", rating: 9.4, features: ["Myke Towers"] },
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-12 z-10">
                    <div className="flex flex-col md:flex-row gap-8 items-end">
                        ...
                        <div className="flex-1 space-y-5">
                            ...
                            <RatingAndQuickActions rating={albumData.rating} />
                        </div>
