import { Artist, ShortReview, SonicProfile, Rankings, ArtistsPerformance, SongArtistMinInfo } from "@repo/types";
import { ArtistOnSong } from "../generated/prisma";

export const userReviews: ShortReview[] = [
    {
        id: "1",
        username: 'Lucia.mp3',
        userImage: 'https://avatar.vercel.sh/lucia',
        rating: 9.6,
        date: 'Hace 2 horas',
        likes: 31,
        commentsLength: 4,
    ...
    },
    {
        id: "2",
        username: 'NicoLynz',
        userImage: 'https://avatar.vercel.sh/nico',
        rating: 8.9,
        date: 'Hace 5 horas',
        likes: 18,
        commentsLength: 2,
    ...
    },
    {
        id: "3",
        username: 'Sofia.wav',
        userImage: 'https://avatar.vercel.sh/sofia',
        rating: 9.3,
        date: 'Ayer',
        likes: 22,
        commentsLength: 6,
...
export const sonicProfile: SonicProfile = [
...
export const artistPerformance = [
  {
    id: 1,
    name: "Omar Courtz",
    role: "Main Artist",
...
export const getMockArtistPerformance = (mbid: string, artists: SongArtistMinInfo[]) => {
  //El parametro artists no se va a necesitar, se usa ahorita para hacer el mockData
  const artistPerformance = artists.map((artist: any) => ({
    id: artist.id,
    name: artist.name,
    role: artist.role,
...
export const rating = 9.9;

export const songRatings = [
  9.3, 9.6, 9.1, 9.4, 9.7, 8.6, 9.9, 8.9, 9.3, 9.8, 9.5, 9.2, 9.4, 9.0, 8.8,
  9.7, 9.1, 9.6, 9.3, 8.7, 9.8, 9.0, 9.4, 9.2, 8.9, 9.5, 9.1, 9.7, 8.6, 9.3,
  9.8, 9.0, 8.8,
];
...
export const artistRankings: Rankings = [
  { id: "1", title: "Top Global", rank: "#56" },
...
export const topTracks = [
  {
    ...
    features: ["Bad Gyal"],
    image:
      "https://i1.sndcdn.com/artworks-72d80e69-18fe-4175-b049-3393db902285-0-t500x500.jpg",
  },
  {
    id: 18,
    artist: "Omar Courtz",
...
export const getRandomRating = () => {
  console.log("Generando rating aleatorio...");
  return (Math.random() * 5 + 5).toFixed(1); // Genera un número entre 5.0 y 10.0
}