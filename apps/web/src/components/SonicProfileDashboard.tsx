...
import { Album, Artist, Song, SonicProfile } from '@repo/types';


const SonicProfileDashboard = ({ data = null, sonicProfile, image=true, header=true, oneLine=false }:
    {
...
export default SonicProfileDashboard