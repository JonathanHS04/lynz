...
import { ArtistsPerformance as ArtistsPerformanceType} from '@repo/types';

const ArtistsPerformance = ({artistPerformance}: {artistPerformance: ArtistsPerformanceType}) => {
    return (
