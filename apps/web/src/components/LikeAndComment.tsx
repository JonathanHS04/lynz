...
import { AlbumReviewWithLike, ShortReview, SongReviewWithLike } from '@repo/types';


const LikeAndComment = ({ review, setReviewState }: 
    { 
        review: ShortReview, 
        setReviewState: React.Dispatch<React.SetStateAction<(ShortReview)[]>> 
    }) => {
