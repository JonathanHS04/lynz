...
import { SongReview, AlbumReview, SongReviewWithLike, AlbumReviewWithLike, ShortReview } from '@repo/types';
...
const UserReviewsPanel = ({ reviews = [], type, id }: {
    ...
    const [reviewState, setReviewState] = useState<(ShortReview)[]>(
        reviews.map((review) => ({
            ...review,
            liked: false,
        }))
                ...
                {reviewState.map((review) => (
                    ...
                    >
                        ...
                        <div className="mt-3 flex items-center gap-2">
                            <LikeAndComment review={review} setReviewState={setReviewState} />
