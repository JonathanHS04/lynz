...
const ArtistHero = ({ artistData }: { artistData: Artist }) => {    

    // Verificamos si la imagen es el placeholder por defecto
    const isPlaceholder = artistData.image === null || artistData.image === "null";
                    ...
                    <div className="flex-1 space-y-6 pt-12">
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3 text-sm font-bold text-zinc-300 uppercase tracking-[0.18em]">
                                ...
                                <span>{new Date(artistData.activeSince).getFullYear()}</span>
                            </div>
                        </div>
