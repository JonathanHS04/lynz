                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-12 z-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center md:items-end text-center md:text-left">
                        <div className="relative group shrink-0 shadow-[0_0_80px_rgba(139,92,246,0.2)] rounded-full overflow-hidden w-64 h-64 md:w-80 md:h-80 border-4 border-white/5">
                            <img src={songData.image} className="w-full h-full object-cover" alt={songData.name} />
                        ...
                        <div className="flex-1 space-y-6">
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-center md:justify-start gap-3 text-2xl font-bold">
                                    <ArtistsText
                                        ...
                                        mainClass="text-white hover:text-violet-400 transition-colors cursor-pointer"
                                        featureClass="text-zinc-600 tracking-tighter font-black italic hover:text-violet-400 transition-colors"
                                        links={true}
                                        features={true}
                                    />
                            ...
                            <RatingAndQuickActions data={songData} type="song"  />
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-12">
                    ...
                    <div className="space-y-12">
                        <SonicProfileDashboard data={songData} sonicProfile={songData.sonicProfile} />

                        {/* PERFORMANCE */}
                        <ArtistsPerformance artistPerformance={songData.artistsPerformance} />
                    </div>
